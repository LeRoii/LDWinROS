...
int main(int argc, char** argv)
{
  ...
  private_node_handle.param<std::string>("INSport", port, "/dev/ttyUSB0");
  ...
  ros::Publisher velo_pub = nh.advertise<geometry_msgs::Vector3>("velocity", 200);
           ...
           if (data_packet_start != std::string::npos)
           {
            if (input.find(0x0B)-data_packet_start == 2)
            {
              ...
              if (input[data_packet_start +Length-1]==xorcheck ) //input[data_packet_start +Length-1]==xorcheck 
              {
                ...
                //get velocity
                short int vx = ((0xff &(char)input[data_packet_start + 34]) << 8) | (0xff &(char)input[data_packet_start + 33]);
                short int vy = ((0xff &(char)input[data_packet_start + 36]) << 8) | (0xff &(char)input[data_packet_start + 35]);
                short int vz = ((0xff &(char)input[data_packet_start + 38]) << 8) | (0xff &(char)input[data_packet_start + 37]);

                velocity.x = vx*0.01/32768;
                velocity.y = vy*0.01/32768;
                velocity.z = vz*0.01/32768;

                
                // get RPY
                short int roll = ((0xff &(char)input[data_packet_start + 4]) << 8) | (0xff &(char)input[data_packet_start + 3]);
                short int pitch = ((0xff &(char)input[data_packet_start + 6]) << 8) | (0xff &(char)input[data_packet_start + 5]);
                short int yaw = ((0xff &(char)input[data_packet_start + 8]) << 8) | (0xff &(char)input[data_packet_start + 7]);
                ...
                short int gx = ((0xff &(char)input[data_packet_start + 10]) << 8) | (0xff &(char)input[data_packet_start + 9]);
                short int gy = ((0xff &(char)input[data_packet_start + 12]) << 8) | (0xff &(char)input[data_packet_start + 11]);
                short int gz = ((0xff &(char)input[data_packet_start + 14]) << 8) | (0xff &(char)input[data_packet_start + 13]);
               ...
               // double gzf = gz * (4000.0/65536.0) * (M_PI/180.0) * 25.0;
                ...
                //int ax = (((0xff &(char)input[data_packet_start + 18]) << 24) |((0xff &(char)input[data_packet_start + 17]) << 16) |((0xff &(char)input[data_packet_start + 16]) << 8) | 0xff &(char)input[data_packet_start + 15]);
                //int ay = (((0xff &(char)input[data_packet_start + 22]) << 24) |((0xff &(char)input[data_packet_start + 21]) << 16) |((0xff &(char)input[data_packet_start + 20]) << 8) | 0xff &(char)input[data_packet_start + 19]);
                //int az = (((0xff &(char)input[data_packet_start + 26]) << 24) |((0xff &(char)input[data_packet_start + 25]) << 16) |((0xff &(char)input[data_packet_start + 24]) << 8) | 0xff &(char)input[data_packet_start + 23]);
                 short int ax = ((0xff &(char)input[data_packet_start + 16]) << 8) | (0xff &(char)input[data_packet_start + 15]);
                 short int ay = ((0xff &(char)input[data_packet_start + 18]) << 8) | (0xff &(char)input[data_packet_start + 17]);
                 short int az = ((0xff &(char)input[data_packet_start + 20]) << 8) | (0xff &(char)input[data_packet_start + 19]);   
                ...
                int latitude = (((0xff &(char)input[data_packet_start + 24]) << 24) |((0xff &(char)input[data_packet_start + 23]) << 16) |((0xff &(char)input[data_packet_start + 22]) << 8) | 0xff &(char)input[data_packet_start + 21]);
                int longitude = (((0xff &(char)input[data_packet_start + 28]) << 24) |((0xff &(char)input[data_packet_start + 27]) << 16) |((0xff &(char)input[data_packet_start + 26]) << 8) | 0xff &(char)input[data_packet_start + 25]);
                int altitude = (((0xff &(char)input[data_packet_start + 32]) << 24) |((0xff &(char)input[data_packet_start + 31]) << 16) |((0xff &(char)input[data_packet_start + 30]) << 8) | 0xff &(char)input[data_packet_start + 29]);
	        ...
	        // publish gps message
                ...
                // else
                {
                  ...
                  ROS_INFO("gps sending!!!!!!!!!!!!!!!, lon:%f, lat:%f", longitudef, latitudef);
              ...
              input.erase(0, data_packet_start + Length); // delete everything up to and including the processed packet
            }
            else
            {
